...
const SendComment = (ID) => {
  // State variables for the comment form
  ...
  // Prepare contract write for adding a comment
  ...
  // Use contract write for sending a comment
  const {
    write: sendComments,
    isSuccess,
    isLoading,
  ...
  useEffect(() => {
    ...
    if (Success === true) {
      ...
      setCommentText(""); // Clear the comment text input after a successful comment
    }
    if (Error === true) {
