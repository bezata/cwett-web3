            ...
            <div className="transparent shadow-purple-600/90 hover:shadow-purple-700/90 rounded-lg overflow-hidden shadow-xl z-50 relative">
              <div className="p-6 min-w-[18.75rem] flex flex-col items-center">
                ...
                <button
                  ...
                  className="text-white bg-transparent shadow shadow-purple-600 focus:ring-4 focus:outline-none border hover:border-purple-500 border-purple-600 font-medium rounded-lg text-sm px-5 py-2.5"
                >
                  Follow
                </button>
